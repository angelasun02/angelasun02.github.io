...
if(hour <= 14 && minute <= 0 && second <= 0){window.location.href='ÖzlemAltın.html';}
else if(hour >= 14 && minute >= 0 && second >= 0){window.location.href='ZoraJMurff.html';}
...
refreshAt(14,0,0); //Will refresh the page at 14:00pm
