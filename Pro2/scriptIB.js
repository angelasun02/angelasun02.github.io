...
if(hour <= 17 && minute <= 0 && second <= 0){window.location.href='IñakiBonillas.html';}
else if(hour >= 17 && minute >= 0 && second >= 0){window.location.href='DionneLee.html';}
...
refreshAt(17,0,0); //Will refresh the page at 17:00pm
