...
if(8 <= hour <= 9 && minute <= 30){window.location.href='MariaAntelman.html';}
if(hour <= 10 && minute <= 30){window.location.href='SohrabHura.html';}
if(hour <= 11 && minute <= 30){window.location.href='DavidAlekhuogie.html';}
if(hour <= 14 && minute <= 30){window.location.href='ÖzlemAltın.html';}
if(hour <= 15 && minute <= 30){window.location.href='ZoraJMurff.html';}
if(hour <= 16 && minute <= 30){window.location.href='IrinaRozovsky.html';}
if(hour <= 17 && minute <= 30){window.location.href='IñakiBonillas.html';}
if(hour <= 18 && minute <= 30){window.location.href='DionneLee.html';}
else {window.location.href='IrinaRozovsky.html';}
...
$(document).ready(function(){
  ...
  $( ".button" ).click(function() {
    ...
    $(".img5drag").css("height","200px");
    $(".img5drag").css("margin-top","0px");
    $(".img5drag").css("margin-left","0px");
    ...
    $( ".img5drag" ).click(function() {
    $(".imgblank1").css("display","none");
    $(".enlarge").css("display","block");
    $(".button").css("display","block");
    $(".img5drag").css("height","540px");
    $(".img5drag").css("margin-left","8px");
    $(".img5drag").css("margin-top","8px");
    $(".collection").css("position","relative");
    $("h1").css("margin-top","-70px");
    $(".MA").css("margin-top","10px");
    $(".img5intro").css("display","block");
    $(".img5intro").css("position","fixed");
    $(".img5intro").css("margin-left","-492px");
    $(".img5intro").css("margin-top","198px");
    $(".img2").css("display","none");
    $(".img3").css("display","none");
    $(".img4").css("display","none");
    $(".img6").css("display","none");
  ...
  $( ".left3" ).click(function() {
    ...
    $(".img5intro").css("display","none");
    $(".img4intro").css("display","block");
    $(".img4intro").css("margin-left","-500px");
    $(".img4intro").css("margin-top","190px");
    $(".collection").css("position","fixed");
    $("h1").css("margin-top","0px");
    $(".MA").css("margin-top","80px");
    $(".img1").css("display","none");
    ...
    $(".img5intro").css("display","none");
    $(".img6intro").css("display","block");
    $(".img6intro").css("margin-left","-492px");
    $(".img6intro").css("margin-top","198px");
    $(".img1").css("display","none");
    $(".img2").css("display","none");
    $(".img3").css("display","none");
    $(".img4").css("display","none");
