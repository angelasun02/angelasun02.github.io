...
if(hour <= 16 && minute <= 0 && second <= 0){window.location.href='IrinaRozovsky.html';}
else if(hour >= 16 && minute >= 0 && second >= 0){window.location.href='IñakiBonillas.html';}
...
refreshAt(16,0,0); //Will refresh the page at 16:00pm
