...
if(hour <= 8 && minute <= 0 && second <= 0){window.location.href='Break.html';}
else if(hour >= 8 && minute >= 0 && second >= 0){window.location.href='MariaAntelman.html';}
...
refreshAt(8,0,0); //Will refresh the page at 8:00am
