...
else {window.location.href='Break.html';}
...
$(document).ready(function(){
  ...
  $( ".button" ).click(function() {
    ...
    $(".img6drag").css("height","200px");
    $(".img6drag").css("margin-top","0px");
    $(".img6drag").css("margin-left","0px");
    ...
    $( ".img6drag" ).click(function() {
    $(".imgblank1").css("display","none");
    $(".enlarge").css("display","block");
    $(".button").css("display","block");
    $(".img6drag").css("height","540px");
    $(".img6drag").css("margin-left","8px");
    $(".img6drag").css("margin-top","8px");
    $(".collection").css("position","relative");
    $("h1").css("margin-top","-70px");
    $(".MA").css("margin-top","10px");
    $(".img6intro").css("display","block");
    $(".img6intro").css("position","fixed");
  ...
  $( ".left3" ).click(function() {
    ...
    $(".img6intro").css("display","none");
    $(".img5intro").css("display","block");
    $(".img5intro").css("margin-left","-500px");
    $(".img5intro").css("margin-top","190px");
    $(".collection").css("position","fixed");
    $("h1").css("margin-top","0px");
    $(".MA").css("margin-top","80px");
    $(".img1").css("display","none");
